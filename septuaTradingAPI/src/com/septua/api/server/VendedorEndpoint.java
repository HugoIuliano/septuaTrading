...
@Api(name = "vendedorendpoint", namespace = @ApiNamespace(ownerDomain = "septua.com", ownerName = "septua.com", packagePath = "api.server"))
public class VendedorEndpoint {
	...
	@ApiMethod(name = "listVendedor")
	public CollectionResponse<Vendedor> listVendedor(@Nullable @Named("cursor") String cursorString,
